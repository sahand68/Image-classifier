...
def train_model(model, hidden_units , epochs,learning_rate,device=device):
...
def main():
    ...
    trained_model =train_model(loaded_model, hidden_units , epochs,learning_rate = 0.001,device=device)
    ...
    torch.save(checkpoint, 'mycheckpoint.pth.tar')
