...
#this is my network accuracy on test data set..
...
probs, top_classes =predict('flowers/train/10/image_07087.jpg', loaded_model, topk=5, device='gpu')
...
img = mpimg.imread('flowers/train/10/image_07087.jpg')
plt.rcdefaults()
